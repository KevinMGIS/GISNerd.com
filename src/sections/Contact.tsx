export default function Contact() {
  ...
  <a href="mailto:kevin@gisnerd.com" className="px-4 py-2 rounded-md bg-primary text-black font-medium">Email</a>
        <a href="https://www.linkedin.com/in/" target="_blank" rel="noreferrer" className="px-4 py-2 rounded-md border border-white/20 hover:border-white/30 hover:bg-white/5 transition-colors">LinkedIn</a>
      </div>
    </section>
  )
}
