export default function Contact() {
  ...
  <section id="contact" className="pt-12 pb-24 snap-section">
      ...
      <div className="mt-6 flex gap-4">
        <a href="mailto:hello@gisnerd.com" className="px-4 py-2 rounded-md bg-primary text-black font-medium">Email</a>
        ...
        <a href="https://github.com/KevinMGIS" target="_blank" rel="noreferrer" className="px-4 py-2 rounded-md border border-white/10">GitHub</a>
      </div>
    </section>
  )
}
